...
class Customer:
    ...
    def saveData(self):
        with open('./20190615python/customer/data.pickle', 'wb') as f:
            pickle.dump(self.custlist, f)

    def loadData(self):
        if os.path.exists('/20190615python/customer/data.pkl'):
            with open('./20190615python/customer/data.pkl', 'rb') as f:
