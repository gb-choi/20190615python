...
class Customer:
    ...
    def saveData(self):
        with open('./20190615python/customer/data.json', 'wt') as f:
            json.dump(self.custlist, f, indent=4)
            
            
    def loadData(self):
        if os.path.exists('/20190615python/customer/data.json'):
            with open('./20190615python/customer/data.json', 'rt') as f:
